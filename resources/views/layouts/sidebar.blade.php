...
>
    ...
    >
            ...
            ADMIN MENU
                ...
                Users
                            ...
                            >
                                <li>
                                    <a
                                        ...
                                        :class="page === 'manageStudents' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                                    >
                                        Manage Students
                                    </a>
                                </li>
                                <li>
                                    <a
                                        href="#"
                                        class="menu-dropdown-item group"
                                        :class="page === 'manageTeachers' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                                    >
                                        Manage Teachers
                                    </a>
                                </li>
                                <li>
                                    <a
                                        href="#"
                                        class="menu-dropdown-item group"
                                        :class="page === 'manageAdmins' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                                    >
                                        Manage Admins
                                    </a>
                                </li>
                    ...
                    <li>
                        <a
                            href="#"
                            @click.prevent="selected = (selected === 'Classes' ? '':'Classes')"
                            class="menu-item group"
                            :class="selected === 'Classes' ? 'menu-item-active' : 'menu-item-inactive'"
                        >
                            <svg
                                :class="selected === 'Classes' ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                width="24"
                                height="24"
                                viewBox="0 0 24 24"
                                fill="none"
                ...
                Classes
                            ...
                            <svg
                                class="menu-item-arrow"
                                :class="[(selected === 'Classes') ? 'menu-item-arrow-active' : 'menu-item-arrow-inactive', sidebarToggle ? 'lg:hidden' : '' ]"
                                width="20"
                                height="20"
                                viewBox="0 0 20 20"
                                fill="none"
                        ...
                        <div
                            class="overflow-hidden transform translate"
                            :class="selected === 'Classes' ? 'block' :'hidden'"
                        >
                            <ul
                                :class="sidebarToggle ? 'lg:hidden' : 'flex'"
                                class="flex flex-col gap-1 mt-2 menu-dropdown pl-9"
                            >
                                <li>
                                    <a
                                        href="#"
                                        class="menu-dropdown-item group"
                                        :class="page === 'addRemoveClasses' ? 'menu-dropdown-item-active' : 'menu-dropdown-item-inactive'"
                                    >
                                        Add/Remove Classes
                                    </a>
                                </li>
                    ...
                    <ul class="flex flex-col gap-4 mb-6">
                        ...
                        <li>
                            <a
                                ...
                                @click="selected = (selected === 'Grades' ? '' : 'Grades')"
                                class="menu-item group"
                                :class="(selected === 'Grades' || '{{ Request::segment(2) }}' === 'dashboard') ? 'menu-item-active' : 'menu-item-inactive'"
                            >
                                <svg
                                    :class="(selected === 'Grades' || '{{ Request::segment(2) }}' === 'dashboard') ? 'menu-item-icon-active' : 'menu-item-icon-inactive'"
                                    width="24"
                                    height="24"
                                    viewBox="0 0 24 24"
                                    fill="none"
        ...
        >
            ...
            <a href="https://instagram.com/issamiaymane"
               target="_blank"
               rel="nofollow"
               class="flex items-center justify-center p-3 font-medium text-white rounded-lg bg-brand-500 text-theme-sm hover:bg-brand-600">
                Let's Connect on Instagram
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6">
                    <path fill-rule="evenodd" d="M7 2a5 5 0 0 0-5 5v10a5 5 0 0 0 5 5h10a5 5 0 0 0 5-5V7a5 5 0 0 0-5-5H7Zm0 2h10a3 3 0 0 1 3 3v10a3 3 0 0 1-3 3H7a3 3 0 0 1-3-3V7a3 3 0 0 1 3-3Zm9 1.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3ZM12 6a6 6 0 1 0 0 12A6 6 0 0 0 12 6Zm0 2a4 4 0 1 1 0 8 4 4 0 0 1 0-8Z" clip-rule="evenodd"/>
                </svg>
            </a>
