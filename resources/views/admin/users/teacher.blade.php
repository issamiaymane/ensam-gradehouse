        ...
        <div class="mx-auto max-w-(--breakpoint-2xl) p-4 md:p-6">
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div class="space-y-6">
                    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                        <div class="px-5 py-4 sm:px-6 sm:py-5">
                            <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Add Teacher</h3>
                        </div>
                        <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                            ...
                            <form action="{{ route('teacher.store') }}" method="POST">
                                ...
                                <!-- Submit Button -->
                                <div class="mt-6">
                                    <button type="submit" class="w-full rounded-lg bg-brand-500 px-4 py-2.5 text-sm font-medium text-white hover:bg-brand-600 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:ring-offset-2 dark:bg-brand-600 dark:hover:bg-brand-700 dark:focus:ring-brand-600">Add Teacher</button>
                                </div>
                            </form>
                        </div>
                    </div>
                ...
                <div class="space-y-6">
                    <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
                        <div class="px-5 py-4 sm:px-6 sm:py-5">
                            <h3 class="text-base font-medium text-gray-800 dark:text-white/90">Teacher List</h3>
                        </div>
                        <div class="space-y-6 border-t border-gray-100 p-5 sm:p-6 dark:border-gray-800">
                            <!-- Loop through teachers and display each one -->
                            @foreach($teachers as $teacher)
                                <div class="flex items-center justify-between">
                                    <div>
                                        <h4 class="text-sm font-medium text-gray-800 dark:text-white/90">{{ $teacher->user->first_name }} {{ $teacher->user->last_name }}</h4>
                                    ...
                                    <div class="flex items-center gap-2">
                                        ...
                                        <!-- Delete Button -->
                                        <form action="{{ route('teacher.delete', $teacher->id) }}" method="POST" onsubmit="return confirm('Are you sure you want to delete this teacher?');">
                                            @csrf
                                            @method('DELETE')
