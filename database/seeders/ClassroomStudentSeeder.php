...
class ClassroomStudentSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $this->seedStudents($students1, 1);
        $this->seedStudents($students2, 2);

        $this->command->info("Classroom students have been seeded successfully.");
    }

    private function seedStudents(array $students, int $classroomSchoolYearId)
    {
        foreach ($students as $data) {
            [$apogee, $firstName, $lastName] = $data;
